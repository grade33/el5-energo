...
;// CONCATENATED MODULE: ./src/scripts/modules/promo/wcc/slider.js
...
;// CONCATENATED MODULE: ./src/scripts/modules/promo/wcc/windInfo.js
function windInfoOpenClose() {
  var btn = document.querySelector('.wind__btn');
  var closeBtn = document.querySelector('.wind__btn-close');
  var info = document.querySelector('.wind__slider');
  btn.addEventListener('click', function () {
...
;// CONCATENATED MODULE: ./src/scripts/promo-wcc.js
